...
def summarize_order(order):
    ...
    """
    print_order(order)
    total_without_tax = calculate_subtotal(order)
    tax = calculate_tax(total_without_tax)
    total = round(total_without_tax + tax, 2)
...
def main():
    ...
    print(f"Items: {items}, Total after tax: {total}")
